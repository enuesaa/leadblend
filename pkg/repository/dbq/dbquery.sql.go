...
INSERT INTO islands (resource_id, title, content, comment) VALUES (?, ?, ?, ?) RETURNING id, resource_id, title, content, comment, created, updated
`
...
INSERT INTO patterns (resource_id, title, priority) VALUES (?, ?, ?) RETURNING id, resource_id, title, priority, created, updated
`
...
func (q *Queries) CreatePattern(ctx context.Context, arg CreatePatternParams) (Pattern, error) {
	row := q.db.QueryRowContext(ctx, createPattern, arg.ResourceID, arg.Title, arg.Priority)
	var i Pattern
	err := row.Scan(
		&i.ID,
		&i.ResourceID,
...
INSERT INTO planets (resource_id, name, comment) VALUES (?, ?, ?) RETURNING id, resource_id, name, comment, created, updated
`
...
func (q *Queries) CreatePlanet(ctx context.Context, arg CreatePlanetParams) (Planet, error) {
	row := q.db.QueryRowContext(ctx, createPlanet, arg.ResourceID, arg.Name, arg.Comment)
	var i Planet
	err := row.Scan(
		&i.ID,
		&i.ResourceID,
...
INSERT INTO stones (resource_id, pattern_id, island_id, data) VALUES (?, ?, ?, ?) RETURNING id, resource_id, pattern_id, island_id, data, created, updated
`
...
INSERT INTO traits (resource_id, pattern_id, path, type, default_value, required) VALUES (?, ?, ?, ?, ?, ?) RETURNING id, resource_id, pattern_id, path, type, default_value, required, created, updated
`
...
SELECT id, resource_id, title, content, comment, created, updated FROM islands WHERE id = ?
`
...
SELECT id, resource_id, title, priority, created, updated FROM patterns WHERE id = ?
`
...
SELECT id, resource_id, name, comment, created, updated FROM planets WHERE name = ?
`
...
SELECT id, resource_id, pattern_id, island_id, data, created, updated FROM stones WHERE id = ?
`
...
SELECT id, resource_id, pattern_id, path, type, default_value, required, created, updated FROM traits WHERE id = ?
`
...
SELECT id, resource_id, title, content, comment, created, updated FROM islands
`
...
SELECT id, resource_id, title, priority, created, updated FROM patterns
`
...
SELECT id, resource_id, name, comment, created, updated FROM planets
`
...
SELECT id, resource_id, pattern_id, island_id, data, created, updated FROM stones
`
...
SELECT id, resource_id, pattern_id, path, type, default_value, required, created, updated FROM traits
`
