...
describe('convertCometData', () => {
  ...
  it('object values', () => {
    expect(convertCometData('{"a":{"b":"c"}}')[0]).toStrictEqual({
      type: 'object', key: '', values: [
        {type: 'object', key: 'a', values: [
          {type: 'string', key: 'b', value: 'c'},
        ]},
      ],
    })
  })
